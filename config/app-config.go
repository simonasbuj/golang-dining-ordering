...
// StorageType represents the configured backend used for file storage.
type StorageType string

const (
	// StorageTypeLocal indicates local filesystem storage.
...
type AppConfig struct {
	...
	StorageType              StorageType `env:"DINE_STORAGE_TYPE"`
